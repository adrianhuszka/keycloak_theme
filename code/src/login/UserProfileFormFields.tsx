                    ...
                    input: {
                        endAdornment:
                            attribute.name == "password" || attribute.name === "password-confirm" ? (
                                <PasswordToggle i18n={i18n} kcClsx={kcClsx} passwordInputId={attribute.name} />
                            ) : undefined
                    }
                }}
                id={attribute.name}
...
function PasswordToggle(props: { kcClsx: KcClsx; i18n: I18n; passwordInputId: string }) {
    const { i18n, passwordInputId } = props;
    const { msgStr } = i18n;
